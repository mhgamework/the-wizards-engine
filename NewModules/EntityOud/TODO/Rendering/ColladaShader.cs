...
namespace MHGameWork.TheWizards.ServerClient.Entity.Rendering
{
    ...
    /// TODO: now a verry similar implementation of this class exists in the Graphics module!
    /// </summary>
    public class ColladaShader
    {
        ...
        private void LoadShader( EffectPool pool )
        {
            ...
            string shaderFilename = System.Windows.Forms.Application.StartupPath + @"\Shaders\ColladaModel.fx";
            //
