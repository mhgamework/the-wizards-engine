...
namespace MHGameWork.TheWizards.Rendering.Vegetation.Trees
{
    public class EngineTreeRenderDataGenerater
    {
        ...
        public EngineTreeRenderData GetRenderData(TreeStructure treeStructure, DX11Game game, int lodLevel)
        {
        ...
        private void GenerateRenderData(DX11Game game, int lodLevel, TreeStructure treeStructure)
        {
        ...
        /*public static void TestEngineRenderdataGenerater()
        {
            ...
            TreeGenerator.TreeEngine.EngineTreeRenderData treeRenderData = new TreeGenerator.TreeEngine.EngineTreeRenderData(game);
            TreeGenerator.TreeStructure treeStruct = new TreeGenerator.TreeStructure();
