...
namespace MHGameWork.TheWizards.Rendering.Deferred
{
    ...
    /// </summary>
    public class DeferredRendererOud : IXNAObject
    {
        ...
        private Rendering.TexturePool texturePool;
        ...
        {
            return BasicShader.LoadFromEmbeddedFile(game, typeof(DeferredRendererOud).Assembly, "MHGameWork.TheWizards.Rendering.Deferred.Files." + filename,
