...
PixelShaderOutput ps_main(VSOut In)
{
    ...
    float3 velocity;
    velocity=oldVelocity.xyz+calculateAcceleration(oldVelocity,oldPosition)*elapsed;//float4(normalize((center.xyz-oldPosition.xyz))*dot(oldVelocity,oldVelocity)*elapsed,1);
