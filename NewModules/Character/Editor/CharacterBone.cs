...
namespace MHGameWork.TheWizards.Character.Editor
{
    public class CharacterBone : Raycast.IRaycastable<CharacterBone>
    {
        ...
        /// <summary>
        /// Matrix currently active
        /// </summary>
        public Matrix CurrentMatrix;

        public CharacterBone( IXNAGame game )
        {
            ...
            BoxMesh = new BoxMesh();
            BoxMesh.Initialize( game );
            BoxMesh.PivotPoint = new Vector3( 0.5f, 0, 0.5f );
        }
        ...
        #region IRaycastable<CharacterBone> Members

        public MHGameWork.TheWizards.Raycast.RaycastResult<CharacterBone> Raycast( Ray ray )
        {
            return new MHGameWork.TheWizards.Raycast.RaycastResult<CharacterBone>( BoxMesh.Raycast( ray ), this );
        }
