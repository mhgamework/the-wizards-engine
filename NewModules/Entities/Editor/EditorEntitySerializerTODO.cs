...
{
    class EditorEntitySerializerTODO
    {
        private List<EditorObject> objects;
        private Dictionary<EditorObject, int> objectIDs;
        private Dictionary<int, EditorObject> objectsDictionary;
        private List<EditorEntity> entities;
        private Dictionary<EditorEntity, int> entityIDs;
        ...
        public EditorEntitySerializerTODO( WizardsEditor nEditor )
        {
            editor = nEditor;
        }
