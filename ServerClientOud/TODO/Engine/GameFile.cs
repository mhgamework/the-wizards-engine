...
{
    public class GameFileOud : IDisposable, Common.Engine.IGameFile
    {
        ...
        public GameFileOud( GameFileManager nManager, int nID, string nAssetName )
        {
            manager = nManager;
            id = nID;
        ...
        public GameFileOud( string fileName )
        {
            manager = null;
            id = -2;
            assetName = fileName;
