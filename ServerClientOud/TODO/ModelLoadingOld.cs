...
namespace MHGameWork.TheWizards.ServerClient
{
    public class ModeLoading : IGameMode
    {
        ...
        public ModeLoading( ServerClientMain nEngine )
        {
            engine = nEngine;
        ...
        private List<Engine.GameFile> synchronizationFiles;
        ...
        void engine_SynchronizeGameFileCompleted( object sender, ServerClientMain.SynchronizeGameFileEventArgs e )
        {
        ...
        Engine.LoadingTaskState LoadGameTask( Engine.LoadingTaskType taskType )
        {
            ...
            if ( outdatedCoreFiles == null )
            {
                ...
                {
                    if ( engine.CoreFileManager.Files[ i ].GameFile.State == MHGameWork.TheWizards.ServerClient.Engine.GameFile.GameFileState.OutOfDate )
                    {
            ...
            {
                if ( outdatedCoreFiles[ 0 ].GameFile.State != MHGameWork.TheWizards.ServerClient.Engine.GameFile.GameFileState.UpToDate )
                {
