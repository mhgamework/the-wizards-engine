...
namespace MHGameWork.TheWizards.ServerClient.Engine
{
    public class ColladaMeshOud
    {
        ...
        private ColladaModelOud model;

        public IndexBuffer indexBuffer;
        public VertexBuffer vertexBuffer;
        public ColladaMaterialOud material;
        ...
        public ColladaMeshOud( ColladaModelOud parentModel )
        {
            model = parentModel;
            game = model.Game;
        ...
        public void AddSource( Source nSource )
        {
            sources.Add( nSource.ID, nSource );

        }

        public void SetPositionsSource( Source nSource, int offset )
        {
        ...
        public void SetNormalsSource( Source nSource, int offset )
        {
        ...
        public void SetTexCoordsSource( Source nSource, int offset )
        {
        ...
        public void SetTangentsSource( Source nSource, int offset )
        {
        ...
        public void LoadMeshGeometry( XmlNode colladaFile, XmlNode meshNode )
        {
            ...
            foreach ( XmlNode node in meshNode )
            {
                ...
                source = new ColladaMeshOud.Source();
            ...
            foreach ( XmlNode trianglenode in meshNode )
            {
                ...
                SetPositionsSource( GetSource( XmlHelper.GetXmlAttribute(
                     positionsnode, "source" ).Substring( 1 ) ), positionsoffset );
                SetNormalsSource( GetSource( XmlHelper.GetXmlAttribute(
                        normalsnode, "source" ).Substring( 1 ) ), normalsoffset );

                SetTexCoordsSource( GetSource( XmlHelper.GetXmlAttribute(
                        texcoordsnode, "source" ).Substring( 1 ) ), texcoordsoffset );
                SetTangentsSource( GetSource( XmlHelper.GetXmlAttribute(
        ...
        public void LoadSkinData( XmlNode colladaFile, XmlNode meshNode )
        {
            ...
            /*XmlNode skinNode = XmlHelper.GetChildNode(
                ...
                "controller" ), "skin" );*/
            objectMatrix = ColladaModelOud.LoadColladaMatrix(
                    ...
                    for ( int boneNum = 0; boneNum < model.bones.Count; boneNum++ )
                        if ( mat.Length / 16 > boneNum )
                        {
                            model.bones[ boneArrayOrder[ boneNum ] ].invBoneSkinMatrix =
                                ColladaModelOud.LoadColladaMatrix( mat, boneNum * 16 );
                        } // for if
                } // if
        ...
        public ColladaMaterialOud Material { get { return material; } }
