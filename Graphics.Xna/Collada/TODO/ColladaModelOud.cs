...
namespace MHGameWork.TheWizards.Graphics.Xna.Collada.TODO
{
    public class ColladaModelOud
    {
        ...
        public List<ColladaMeshOud> meshes = new List<ColladaMeshOud>();
        public List<ColladaMaterialOud> materials = new List<ColladaMaterialOud>();
        public List<ColladaTextureOud> textures = new List<ColladaTextureOud>();



        public ColladaModelOud( IXNAGame _game )
        {
            game = _game;
        }
        ...
        private void LoadTextures( XmlNode colladaFile )
        {
            ...
            ColladaTextureOud tex;

            foreach ( XmlNode image in library_images )
            {
                if ( image.Name == "image" )
                {
                    tex = new ColladaTextureOud( this );
        ...
        private ColladaMaterialOud LoadMaterial( XmlNode colladaFile, XmlNode materialNode )
        {
            ColladaMaterialOud mat = new ColladaMaterialOud();
                ...
                if ( node.Name == "instance_effect" )
                {
                    ...
                    foreach ( XmlNode subNode in technique )
                    {
                        ...
                        if ( subNode.Name == "phong" || subNode.Name == "blinn" )
                        {
                            ...
                            {
                                case "phong:":
                                    mat.Type = ColladaMaterialOud.MaterialType.Phong;
                                    break;
                                case "blinn":
                                    mat.Type = ColladaMaterialOud.MaterialType.Blinn;
                                    break;
        ...
        private void UpdateAnimation( Matrix renderMatrix )
        {
            ...
            int aniMatrixNum = ( (int)( 100 +
                ...
                ( game.Elapsed ) * frameRate ) ) % numOfAnimations;
            if ( aniMatrixNum < 0 )
                aniMatrixNum = 0;
        ...
        private void LoadScene( XmlNode colladaFile )
        {
            ...
            foreach ( XmlNode node in visual_scene )
            {
                ...
                ColladaMeshOud mesh = GetMesh( meshName );
                if ( mesh != null )
                {
                    ...
                    Matrix objectMatrix = LoadColladaMatrix( matrixData, 0 );
        ...
        public ColladaMaterialOud GetMaterial( string name )
        {
        ...
        public ColladaMeshOud GetMesh( string name )
        {
        ...
        public ColladaTextureOud GetTexture( string name )
        {
        ...
        public static void TestColladaModelSkinnedSimple()
        {
            ...
            TestXNAGame.Start( "TestColladaModel001",
                delegate
                {
                    ...
                    model = new ColladaModelOud( main );

                    ColladaMaterialOud mat = new ColladaMaterialOud();
                    ColladaMeshOud mesh = new ColladaMeshOud( model );
                ...
                delegate
                {
                    if ( !started || main.Keyboard.IsKeyPressed( Microsoft.Xna.Framework.Input.Keys.L ) )
                    {
                        ...
                        effect = new ShaderEffect( main, main.RootDirectory + @"\Content\SkinnedNormalMapping.fx" );
                    ...
                    if ( vertexDeclaration != null ) vertexDeclaration = SkinnedTangentVertex.CreateVertexDeclaration( model.game );
        ...
        public static void TestColladaModel001()
        {
            ...
            TestXNAGame.Start( "TestColladaModel001",
                delegate
                {
                    ...
                    model.Load( main.RootDirectory + @"\Content\Wall001.DAE" );
                ...
                delegate
                {
                    ...
                    {
                        started = true;
                        effect = new ShaderEffect( main, main.RootDirectory + @"\Content\SimpleShader.fx" );
                        //effect = new ShaderEffect( main, main.EngineFiles.RootDirectory + @"\Content\SkinnedNormalMapping.fx" );
                        effect.Load( main.Content );
                    }
        ...
        public static void TestShowBones()
        {
            ...
            TestXNAGame.Start( "TestColladaModel001",
                delegate
                {
                    ...
                    //model.Load( main.EngineFiles.RootDirectory + @"\Content\HuisjeInBos.DAE" );
                    //model.Load( main.EngineFiles.RootDirectory + @"\Content\SimpleBones001.DAE" );
                    model.Load( main.RootDirectory + @"\Content\test_man_baked.DAE" );
                    //model.Load( main.EngineFiles.RootDirectory + @"\Content\SimpleCharacterAnim001.DAE" );
