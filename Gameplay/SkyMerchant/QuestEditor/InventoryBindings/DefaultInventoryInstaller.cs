...
namespace MHGameWork.TheWizards.SkyMerchant.QuestEditor.InventoryBindings
{
    ...
    public class DefaultInventoryInstaller : IWindsorInstaller
    {
        ...
        {
            return new ScriptsInventoryNode("MHGameWork.TheWizards.SkyMerchant", t => new ScriptToolItem(t));
        }
        ...
        private IInventoryNode createTools(IKernel input)
        {
            ...
            ret.AddChild(new HotBarItemInventoryNode(new IslandToolItem(input.Resolve<IWorld>(), input.Resolve<Random>())));
