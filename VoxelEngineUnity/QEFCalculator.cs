...
namespace MHGameWork.TheWizards.DualContouring
{
    public static class QEFCalculator
    {
        ...
        public static Vector<float> CalculateCubeQEF(global::MHGameWork.TheWizards.Vector3_Adapter[] normals, global::MHGameWork.TheWizards.Vector3_Adapter[] posses, global::MHGameWork.TheWizards.Vector3_Adapter preferredPosition)
        {
        ...
        /// <returns></returns>
        public static Vector<float> CalculateCubeQEF(global::MHGameWork.TheWizards.Vector3_Adapter[] normals, global::MHGameWork.TheWizards.Vector3_Adapter[] posses, int numIntersections, global::MHGameWork.TheWizards.Vector3_Adapter preferredPosition)
        {
            List<global::MHGameWork.TheWizards.Vector3_Adapter> normals1 = new List<global::MHGameWork.TheWizards.Vector3_Adapter>(normals.Take(numIntersections));
            List<global::MHGameWork.TheWizards.Vector3_Adapter> posses1 = new List<global::MHGameWork.TheWizards.Vector3_Adapter>(posses.Take(numIntersections));
            global::MHGameWork.TheWizards.Vector3_Adapter preferredPosition1 = preferredPosition;
            ...
            global::MathNet.Numerics.LinearAlgebra.Single.DenseMatrix_Adapter A = global::MathNet.Numerics.LinearAlgebra.Single.DenseMatrix_Adapter.OfRowArrays(normals1.Select(e => new[] { e.X, e.Y, e.Z }).ToArray());
            //var A = DenseMatrix.OfArray(ABuffer); //NOT USED UNSURE IF IT IS BUGGED

            BBuffer[0] = global::MHGameWork.TheWizards.Vector3_Adapter.Dot(normals1[0], posses1[0] - preferredPosition1);
            BBuffer[1] = global::MHGameWork.TheWizards.Vector3_Adapter.Dot(normals1[1], posses1[1] - preferredPosition1);
            BBuffer[2] = global::MHGameWork.TheWizards.Vector3_Adapter.Dot(normals1[2], posses1[2] - preferredPosition1);

            global::MathNet.Numerics.LinearAlgebra.Single.DenseVector_Adapter b = global::MathNet.Numerics.LinearAlgebra.Single.DenseVector_Adapter.OfArray(normals1.Zip(posses1.Select(p => p - preferredPosition1), global::MHGameWork.TheWizards.Vector3_Adapter.Dot).ToArray());
            ...
            return leastsquares + global::MathNet.Numerics.LinearAlgebra.Single.DenseVector_Adapter.OfArray(new[] { preferredPosition1.X, preferredPosition1.Y, preferredPosition1.Z });
        }

        public static Vector<float> CalculateQEF(global::MathNet.Numerics.LinearAlgebra.Single.DenseMatrix_Adapter A, global::MathNet.Numerics.LinearAlgebra.Single.DenseVector_Adapter b)
        {
